 ...
 * 2015年11月6日
 */
public class RealtimeIndicatorsVO implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -2911821896906304316L;
	private Integer id;
	...
	public RealtimeIndicatorsVO(int id, String timeFrame, Double bps, Double historyAccessorRatio, 
			Integer recordCreationNum, Integer bpp, Integer pps, Integer ppf, Integer bpf, Integer packetsLessThan500, 
			Integer pakcetsLessThan1000, Integer packetsLessThan2000, Integer packetsLargeThan2000, 
			Integer bytesLessThan20000, Integer bytesLessThan100000, Integer bytesLargeThan100000, Integer durationLessThan1,
			Integer durationLessThan10, Integer durationLargeThan10){
		this.id = id;
